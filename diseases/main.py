...
'Hepatitis B','Hepatitis C','.pyartattack','Varicoseveins','Hypothyroidism','Hyperthyroidism','Hypoglycemia','Osteoarthristis',
...
w2.config(font=("bold",40), fg='RED',bg='green')
w2.grid(row=1, column=0, columnspan=2, padx=100)

NameLb1 = Label(root, text="")
NameLb1.config(font=("Elephant", 20),bg='green')
...
lr.config(font=("Elephant", 15),bg='red')
...
NameLb.config(font=("Elephant", 20),bg='green')
NameLb.grid(row=13, column=1, pady=10,  sticky=W)

NameLb = Label(root, text="")
NameLb.config(font=("Elephant", 15),bg='green')
NameLb.grid(row=18, column=1, pady=10,  sticky=W)

t3 = Text(root, height=2, width=30)
t3.config(font=("Elephant", 20),bg='pink')
t3.grid(row=20, column=1 , padx=15)
